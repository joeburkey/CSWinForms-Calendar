...
namespace Calendar
{
    public partial class EAppointmentRec : Form
    {
        public bool saved;
        public int _model;
        public DateTime _starting;
        public IAppointment _SelectedAppointment;
        public EAppointmentRec(IAppointment _SelectedAppointment_, int model, DateTime starting)
        {
            saved = false;
            InitializeComponent();
            _model = model;
            if (model == 0)
            {
                ...
                Location.Text = getLocation(_SelectedAppointment.DisplayableDescription);
                Location.SelectionStart = Location.Text.Length;
                Location.SelectionLength = 0;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string newDescription = Subject.Text + ", " + Location.Text+" "+recurring;
