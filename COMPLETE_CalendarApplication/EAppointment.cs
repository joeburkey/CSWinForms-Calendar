...
namespace Calendar
{
    public partial class EAppointment : Form
    {
        public bool saved;
        public int _model;
        public DateTime _starting;
        public IAppointment _SelectedAppointment;
        public EAppointment(IAppointment _SelectedAppointment_, int model, DateTime starting)
        {
            saved = false;
            InitializeComponent();
            _model = model;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string newDescription=Subject.Text+", "+Location.Text;
